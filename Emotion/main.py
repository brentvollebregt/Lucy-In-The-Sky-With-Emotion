...
class MusicGuiProgram(Ui_musicGUI):
    ...
    def visualise(self):
        ...
        # Location of where to put mp3 files
        visualiser_assets_folder = os.getcwd() + "/VisualiserFinal/main_Data/StreamingAssets/"
        # Location of where to put csv to be read
        csv_write_location = os.getcwd() + "/VisualiserFinal/main_Data/StreamingAssets/"
        ...
        # Location of visualisers executable
