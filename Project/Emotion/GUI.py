...
"}")
        ...
        self.buttonLoad.setGeometry(QtCore.QRect(40, 573, 81, 41))
        self.buttonLoad.setStyleSheet("font: 14pt \"MS Shell Dlg 2\";")
        self.buttonLoad.setObjectName("buttonLoad")
        self.title = QtWidgets.QLabel(musicGUI)
        self.title.setGeometry(QtCore.QRect(40, 20, 421, 61))
...
"text-decoration: underline;")
        ...
        self.buttonVisual.setGeometry(QtCore.QRect(251, 573, 100, 41))
        font = QtGui.QFont()
        ...
        self.tableWidget.setGeometry(QtCore.QRect(387, 258, 262, 233))
        ...
        self.status.setGeometry(QtCore.QRect(44, 627, 301, 31))
        self.status.setStyleSheet("font: 11pt \"MS Shell Dlg 2\";")
        self.status.setObjectName("status")
        self.dial = QtWidgets.QDial(musicGUI)
        self.dial.setGeometry(QtCore.QRect(393, 620, 20, 16))
        self.dial.setObjectName("dial")
        self.gradient = QtWidgets.QGraphicsView(musicGUI)
        self.gradient.setGeometry(QtCore.QRect(396, 537, 250, 100))
    ...
    def retranslateUi(self, musicGUI):
        ...
        self.gradient.setToolTip(_translate("musicGUI", "<html><head/><body><p>The location of a song in a valence vs. energy graph can represent the emotion. Blue represents a sad song while orange represents a happy song; most sit somewhere in between.</p></body></html>"))
