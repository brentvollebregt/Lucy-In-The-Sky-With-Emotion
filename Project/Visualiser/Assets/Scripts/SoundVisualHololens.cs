...
public class SoundVisualHololens : MonoBehaviour
{
    ...
    private void SpawnLine()
    {
        ...
        for (int i = 0; i < amnVisual; i++)
        {
            ...
            go.transform.Translate(0.025f * i, 0, 0);

            Material mat = materials[i % 6]; //Change 6 to 3 if wanting to use mood
    ...
    private void UpdateVisual()
    {
        ...
        while (visualIndex < amnVisual)
        {
            ...
            visualList[visualIndex].localScale = new Vector3(0.025f, 0.025f, 0.025f) + Vector3.up * visualScale[visualIndex];
            visualIndex++;
        }
    }
    ...
    {
        GameObject[] cubes = GameObject.FindGameObjectsWithTag("Placeable");
        Material mat;
        Renderer rend;
