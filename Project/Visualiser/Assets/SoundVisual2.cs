...
public class SoundVisual2 : MonoBehaviour
{
    ...
    {
        visualScale2 = new float[amnVisual];
        visualList2 = new Transform[amnVisual];
    ...
    private void UpdateVisual()
    {
        ...
        while (visualIndex < amnVisual)
        {
            ...
            visualList2[visualIndex].localScale = new Vector3(5, 5, 5) + Vector3.up * visualScale2[visualIndex];
            visualIndex++;
        }
    }
