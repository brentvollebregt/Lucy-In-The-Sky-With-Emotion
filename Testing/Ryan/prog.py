...
class MusicGuiProgram(Ui_musicGUI):
        ...
        def toggleRecommended(self):
                ...
                try:
                        #currently a placeholder line. Instead, the recommended songs should be generated by passing
                        #the currently selected song into a generateRecommend function
